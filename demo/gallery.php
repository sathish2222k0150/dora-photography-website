...
<header class="header">
    <div class="nav-section">
        <div class="brand-and-navBtn">
            <img src="images/gallery.png" alt="DORALAB Logo" class="-logo">
...
if ($con) {
    ...
    $categoryResult = mysqli_query($con, "SELECT DISTINCT category FROM tbl_images");

    while ($categoryRow = mysqli_fetch_assoc($categoryResult)) {

        // Fetch images for each category ordered by id
        $category = $categoryRow['category'];
        $result = mysqli_query($con, "SELECT * FROM tbl_images WHERE category='$category' ORDER BY id");

        while ($row = mysqli_fetch_assoc($result)) {
            $imagePath = "Admin/uploads/" . $row['img'];
            ...
            if (file_exists($imagePath)) {
                ...
                echo "<p>Error: Image not found for category '{$row['category']}'</p>";
            }
        }
    }
